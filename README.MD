...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/samratu/Xray_onekey/nginx_forward/install.sh" && chmod +x install.sh && bash install.sh
```
...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/samratu/Xray_onekey/main/install.sh" && chmod +x install.sh && bash install.sh
```
